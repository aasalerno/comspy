...
parser.add_argument('sliceChoice', metavar='Slice', type=int, help='The slice we are looking at for our data.')
...
if __name__ == "__main__":
    ...
    np.save('temp/' + str(int(100*pctg)) + '_slice_' + str(sliceChoice) + '_TV_' + str(TV) + '_XFM_' + str(XFM) + '_lamTrust_' + str(int(100*lam_trust)) + '_xtol_' + str(xtol) + '.npy',imHold)